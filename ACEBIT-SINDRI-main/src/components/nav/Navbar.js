...
const MobileNavItem = ({ item, onClose }) => {
    ...
    return (
      <div>
        <button
          ...
          className="flex items-center justify-between w-full px-4 py-3 text-left text-yellow-200 hover:text-yellow-100 hover:bg-white/20 rounded-xl transition-all duration-300"
        >
          <div className="flex items-center space-x-3">
            <item.icon size={22} className="drop-shadow-lg" />
          ...
          <div className="ml-8 mt-2 space-y-1 animate-slide-up">
            {item.dropdown.map((dropdownItem, index) => (
              <a
                ...
                href={dropdownItem.href}
                onClick={onClose}
                className="flex items-center space-x-3 px-4 py-3 text-blue-100 hover:text-yellow-200 hover:bg-white/20 rounded-lg transition-all duration-300"
              >
  ...
  return (
    <a
      href={item.href}
      onClick={onClose}
      className="flex items-center space-x-3 px-4 py-3 text-yellow-200 hover:text-yellow-100 hover:bg-white/20 rounded-xl transition-all duration-300"
    >
      <item.icon size={22} className="drop-shadow-lg" />
      <span className="font-medium drop-shadow-sm">{item.name}</span>
    </a>
