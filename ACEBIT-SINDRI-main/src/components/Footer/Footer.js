        ...
        <div className="mt-20 p-10 bg-gradient-to-r from-white/10 to-white/5 rounded-3xl border border-white/20 shadow-2xl">
          <div className="text-center">
            <div className="flex items-center justify-center mb-8">
              <span className="inline-flex w-12 h-12 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-2xl items-center justify-center mr-4 ring-2 ring-white/20 shadow-xl">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            <div className="flex items-center space-x-4">
              <a href="/" className="w-10 h-10 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-xl flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300">
