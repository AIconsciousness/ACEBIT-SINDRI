            ...
            <div className="animate-slide-up">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                {features.map((feature, index) => (
                  <div 
                    key={index}
                    className="flex items-start space-x-4 p-4 bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                  >
              ...
              {/* CTA Button */}
              <button className="group relative px-8 py-4 bg-gradient-to-r from-violet-600 to-purple-600 text-white font-semibold rounded-full text-lg transition-all duration-300 hover:from-violet-500 hover:to-purple-500 hover:scale-105 hover:shadow-2xl flex items-center">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-slate-900">Our Achievements</h3>
                      <p className="text-slate-600">Proud milestones</p>
                    </div>
                  </div>
