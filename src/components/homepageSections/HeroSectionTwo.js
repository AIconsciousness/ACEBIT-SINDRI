...
const HeroSectionTwo = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-24 bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-50 relative overflow-hidden">
      {/* Background Pattern */}
            ...
            <div className="animate-slide-up">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                {features.map((feature, index) => (
                  <div 
                    key={index}
                    className="flex items-start space-x-3 sm:space-x-4 p-3 sm:p-4 bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                  >
              ...
              <button 
                ...
                className="group relative px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-violet-600 to-purple-600 text-white font-semibold rounded-full text-base sm:text-lg transition-all duration-300 hover:from-violet-500 hover:to-purple-500 hover:scale-105 hover:shadow-2xl flex items-center justify-center"
              >
                <Users className="w-4 h-4 sm:w-5 sm:h-5 mr-2 group-hover:animate-pulse" />
                Join Our Community
                <div className="absolute inset-0 bg-gradient-to-r from-violet-500 to-purple-500 rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
              </button>
            </div>
          </Col>
