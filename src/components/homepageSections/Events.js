          ...
          <Row className="g-6">
            {upcomingEvents.map((event, index) => (
              <Col key={event.id} lg={4} md={6}>
                <div 
                  className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl animate-slide-up"
