              ...
              <div className="animate-fade-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 mb-5 md:mb-8 animate-slide-up" style={{animationDelay: '0.6s'}}>
                  {features.map((feature, index) => (
                    <div
                      key={index}
                      className="relative flex flex-col md:flex-row items-center justify-center text-center md:text-left md:justify-start space-y-2 md:space-y-0 md:space-x-3 p-2 md:p-3 rounded-xl backdrop-blur-sm border border-white/20 ring-1 ring-white/10 bg-gradient-to-b from-white/15 to-white/5 overflow-hidden transform-gpu will-change-transform hover:-translate-y-1 hover:scale-[1.01] transition-all duration-300"
                      style={{
                ...
                <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center animate-slide-up" style={{animationDelay: '0.8s'}}>
                  ...
                  <button 
                    ...
                    className="px-5 md:px-7 py-2.5 md:py-3.5 border-2 border-white text-white hover:bg-white hover:text-slate-900 font-semibold rounded-full text-sm md:text-lg transition-all duration-300 hover:scale-105 flex items-center justify-center"
                  >
