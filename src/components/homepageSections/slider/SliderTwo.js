...
const SliderTwo = () => {
  ...
  const allEvents = [
    {
      ...
      imgUrl: "https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=800&h=600&fit=crop",
      date: "25-26 Nov 2024",
      attendees: "300+",
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 relative overflow-hidden">
      {/* Background Pattern */}
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                        ...
                        <div className="relative h-64 lg:h-full overflow-hidden">
                          ...
                          <div className="absolute top-4 left-4">
                            <span className={`px-3 py-1 bg-gradient-to-r ${event.color} rounded-full text-xs font-medium text-white`}>
                              {event.type}
                            </span>
                          </div>
                          {event.isSpecial && (
                            <div className="absolute top-4 right-4">
                              <span className="px-3 py-1 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full text-xs font-bold text-white animate-pulse">
                                🌟 SPECIAL EVENT
                              </span>
                            </div>
                          )}
                        ...
                        <div className="p-8 flex flex-col justify-center">
                          <div className="mb-4">
                            ...
                            {event.isSpecial && event.description && (
                              <p className="text-gray-200 leading-relaxed mb-4 text-sm italic">
                                {event.description}
                              </p>
                            )}
                          </div>
                          ...
                          <div className="flex gap-3">
                            <button className="group relative px-6 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-semibold rounded-full transition-all duration-300 hover:from-yellow-400 hover:to-orange-400 hover:scale-105 hover:shadow-xl flex items-center justify-center">
                            ...
                            {event.website && (
                              <a 
                                ...
                                className="group relative px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold rounded-full transition-all duration-300 hover:from-blue-400 hover:to-purple-400 hover:scale-105 hover:shadow-xl flex items-center justify-center"
                              >
                                <Globe size={16} className="mr-2 group-hover:animate-pulse" />
                                Visit Website
